...
{   
    ...
    class TankShellCourse
    {
        ...
        public double dn { set; get; } //table 7.3 khong can nhap
        public int i_th { set; get; } //i_th shell course
        public double Bbl_avail_n { set; get; } //duoc gan gia tri o phia duoi ko can nhap
        public double D_tank { set; get; } //[m] or [ft]
        public double CHT { set; get; } //is the height of each shell course
        public double Bbl_rupture_n { set; get; } //duoc gan gia tri o phia duoi khong can nhap
        /*Calculate Parameter*/
