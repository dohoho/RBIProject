...
namespace RBI.BUS.Calculator
{
    class consequenceAnalysisLvl2
    {
        ...
        {
            return 1.00982 - 0.70372 * Math.Log(double.Parse(rbi.getMw(fluid))) - 0.013045 * Math.Log(double.Parse(rbi.getC(4)) * rate_ln_flame(n)) + 0.18554 * Math.Log(Math.Pow(double.Parse(rbi.getMw(fluid)), 2)) - 0.0014619 * Math.Log(Math.Pow(double.Parse(rbi.getC(4)) * rate_ln_flame(n), 2)) - 0.022131 * Math.Log(double.Parse(rbi.getMw(fluid))) * Math.Log(double.Parse(rbi.getC(4)) * rate_ln_flame(n)) - 0.016572 * Math.Log(Math.Pow(double.Parse(rbi.getMw(fluid)), 3)) + 0.00011281 * Math.Log(Math.Pow(double.Parse(rbi.getC(4)) * rate_ln_flame(n), 3)) + 0.00050697 * Math.Log(double.Parse(rbi.getMw(fluid))) * Math.Log(Math.Pow(double.Parse(rbi.getC(4)) * rate_ln_flame(n), 2)) - 0.0035535 * Math.Log(Math.Pow(double.Parse(rbi.getMw(fluid)), 2)) * Math.Log(double.Parse(rbi.getC(4)) * rate_ln_flame(n));

        }
        public double poi_vn_amb(int n)
        {
            return (1.16928 - 0.39309 * Math.Log(double.Parse(rbi.getMw(fluid))) - 0.053213 * Math.Log(double.Parse(rbi.getC(4)) * rate_vn_flame(n)) + 0.033904 * Math.Log(Math.Pow(double.Parse(rbi.getMw(fluid)), 2)) - 0.0028936 * Math.Log(Math.Pow(double.Parse(rbi.getC(4)) * rate_ln_flame(n), 2)) - 0.0067701 * Math.Log(double.Parse(rbi.getMw(fluid))) * Math.Log(double.Parse(rbi.getC(4)) * rate_ln_flame(n)) / (1 - 0.00110843 * Math.Log(double.Parse(rbi.getMw(fluid))) - 0.094276 * Math.Log(double.Parse(rbi.getC(4)) * rate_vn_flame(n)) + 0.029813 * Math.Log(Math.Pow(double.Parse(rbi.getMw(fluid)), 2)) + 0.0031951 * Math.Log(Math.Pow(double.Parse(rbi.getC(4)) * rate_ln_flame(n), 2)) - 0.058105 * Math.Log(double.Parse(rbi.getMw(fluid))) * Math.Log(double.Parse(rbi.getC(4)) * rate_vn_flame(n))));
        ...
        {
            return poi_ln_amb(n) + (poi_l_ait() - poi_ln_amb(n)) * (t_s - double.Parse(rbi.getC(16))) / (double.Parse(rbi.getAIT(fluid)) - double.Parse(rbi.getC(16)));
        }
        public double poi_vn(int n)
        {
            return poi_vn_amb(n) + (poi_v_ait() - poi_vn_amb(n)) * (t_s - double.Parse(rbi.getC(16))) / (double.Parse(rbi.getAIT(fluid)) - double.Parse(rbi.getC(16)));
        }
        ...
        {
            double a_max_pfn = 0;
            a_max_pfn = mass_availn(n) / (double.Parse(rbi.getC(18)) * frac_ro() * p_l);
            return a_max_pfn;
        }
        ...
        public double qrad_n_jet(int n)
        {
            double qrad_n_jet = 0;
            double mb = m_b();
            qrad_n_jet = double.Parse(rbi.getC(14)) * 0.35 * W_n_jet(n) * 55.50 * Math.Pow(10, 6);
            return qrad_n_jet;
        }
        ...
        public double fact_n_ic(int n)
        {
            ...
            if (representFluid.Equals("Steam"))
                fact_n_ic = Math.Min(rate_n(n) / double.Parse(rbi.getC(5)), 1);
            else if (representFluid.Equals("Acids") || representFluid.Equals("Caustics"))
                fact_n_ic = 0;
