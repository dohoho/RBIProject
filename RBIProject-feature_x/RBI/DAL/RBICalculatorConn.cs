...
namespace RBI.DAL
{
    class RBICalculatorConn
    {
        ...
        public String getRepresentativeFluid_atmosphere_storage_tank(String Fluid)
        {
            MySqlConnection conn = DBUtils.getDBConnection();
            conn.Open();
            String sql = "select `Level 1 Consequence Analysis Representative Fluid` from tbl_properties_storage_tank where Fluid ='" + Fluid + "'";
            String data = null;
            try
            {
                MySqlCommand cmd = new MySqlCommand();
        ...
        ///////////////////////get holesize
        public String getHoleSize(String comStyle, int a)
        {
            String data = null;
            String sql = null;
            if (a == 1) sql = "SELECT Small FROM tbl_component_damage_cost WHERE ComponentType='" + comStyle + "'";
            else if (a == 2) sql = "SELECT Medium FROM tbl_component_damage_cost WHERE ComponentType='" + comStyle + "'";
            else if (a == 3) sql = "SELECT Large FROM tbl_component_damage_cost WHERE ComponentType='" + comStyle + "'";
            else sql = "SELECT Rupture FROM tbl_component_damage_cost WHERE ComponentType='" + comStyle + "'";
            MySqlConnection conn = DBUtils.getDBConnection();
            conn.Open();
            try
            {
        ...
        ////////////////////////// get matial 
        public String getMatCost(String matial)
        {
            MySqlConnection conn = DBUtils.getDBConnection();
            conn.Open();
            String sql = "select CostFactor from tbl_material_cost_factor where Materials ='" + matial + "'";
            String data = null;
            try
            {
                MySqlCommand cmd = new MySqlCommand();
