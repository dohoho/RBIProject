    ...
    public partial class Form1 : DevComponents.DotNetBar.Office2007RibbonForm
    {
        ...
        private List<RiskSummary> Calculator()
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                #region tank shell
                tankShell.ReleaseHoleSize = "Small";
                tankShell.i_th = 2;
                tankShell.D_tank = 19.68;
                tankShell.CHT = 3.28;
                tankShell.componentType = "COURSE-1";
                tankShell.EnvironSensitivity = "Low";
                tankShell.P_lvdike = 10;
                tankShell.P_offsite = 20;
                tankShell.P_onsite = 10;
                tankShell.h_liq = 16.4;
                Debug.WriteLine(
                    "B_leak_release = " + tankShell.Bbl_leak_release() + "\n" +
                 "---------------------------------------------" + "\n" +
