...
namespace RBI.BUS.Calculator
{
    class assetConsequence
    {
        ...
        public double holeCost { set; get; }
        public double matCost { set; get; }
        //equipCost: chi phi $/m2
        public double equipCost { set; get; }
        //prodCost: production cost ($/day)
        public double prodCost { set; get; }
        public double CAinj { set; get; }
        public String Fluid { set; get; }
        //popdens : population density( personnel/m2)
        public double propdens { set; get; }
