...
{   
    ...
    class TankShellCourse
    {
        ...
        FinancialConsequence financial = new FinancialConsequence();
        public TankShellCourse()
        {
            financial.Materials = "1.25Cr-0.5Mo";
            financial.componentType = "COURSE-1";
            financial.prodCost = 1;
            financial.equipCost = 2;
            financial.CAinj = 83.12;
            financial.CAcmd = 0.07024;
            financial.propdens = 2;
            financial.injcost = 2;
            financial.Fluid = "C5";
            financial.mass = 5;
            financial.envcost = 1;
        ...
        {
            return double.Parse(rbi.getC(32)) * Cd * A_n() * Math.Sqrt(2 * g * h_liq);    
        }
        ...
        public double ld_n()
        {
            Bbl_avail_n = (Math.PI * Math.Pow(D_tank, 2)) * (h_liq - (i_th - 1) * CHT) / (4*double.Parse(rbi.getC(13)));
        ...
        public double C_indike { set; get; } // table 7.6
        public double C_ss_onsite { set; get; } // table 7.6
        public double C_ss_offsite { set; get; } // table 7.6
        public double C_water { set; get; } // table 7.6
        public double C_subsoil { set; get; }
        public double C_groundwater { set; get; }
        ...
        {
            return Bbl_leak_release() * (1 - P_lvdike / 1000);
        }
        public double Bbl_leak_ssonsite()
        {
            return P_onsite * (Bbl_leak_release() - Bbl_leak_indike()) / 1000;
        }
        public double Bbl_leak_ssoffsite()
        {
            return P_offsite * (Bbl_leak_release() - Bbl_leak_indike() - Bbl_leak_ssonsite()) / 1000;
        }
        ...
        {
            return Bbl_rupture_release() * (1 - P_lvdike / 1000);
        }
        public double Bbl_rupture_ssonsite()
        {
            return P_onsite * (Bbl_rupture_release() - Bbl_rupture_indike()) / 1000;
        }
        public double Bbl_rupture_ssoffsite()
        {
            return P_offsite * (Bbl_rupture_release() - Bbl_rupture_indike() - Bbl_rupture_ssonsite()) / 1000;
        }
        ...
        {
            return financial.FCcmd();
        }
        //Step 11: Compute FC_prod
        public double FC_prod()
        {
            return financial.FCprod();
        }
    ...
    class TankBottom
    {
        ...
        public double n_rh()
        {
            ...
            double C36 = double.Parse(rbi.getC(36));
        ...
        public double rate_n()
        {
            ...
            if (k_h > double.Parse(rbi.getC(34)) * Math.Pow(dn, 2))
                return double.Parse(rbi.getC(33)) * Math.PI * dn * Math.Sqrt(2 * g * h_liq) * n_rh();
            else
                return double.Parse(rbi.getC(35)) * C_qo * Math.Pow(dn, 0.2) * Math.Pow(h_liq, 0.9) * Math.Pow(k_h, 0.74) * n_rh();
        }
        ...
        public double ld_n()
        {
            Bbl_total = (Math.PI * Math.Pow(D_tank, 2) * h_liq) / (4 * double.Parse(rbi.getC(13)));
        ...
        public String SoilType { set; get; } //table 7.2
        public double uw = 3.732e-5; //tra bang tren internet tai 32oF
        public double pw = 62.43; // lb/ft3
        ...
        public double P_onsite { set; get; }
        public double P_offsite { set; get; }
        public double Ps { set; get; } //soil porosity table 7.2
        ...
        public double k_h_water()
        {
            ...
            Ps = k_h[2];
            return double.Parse(rbi.getC(13)) * (k_h[0] + k_h[1]) / 2;
        }
