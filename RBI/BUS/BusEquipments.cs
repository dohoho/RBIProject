...
namespace RBI.BUS
{
    class BusEquipments
    {
        ...
        {
            eqUtils.add(eq.ItemNo, eq.Name, eq.Qty, eq.Semi_Quanty, eq.Quanlitative, eq.ProcessStream, eq.Pressure, eq.PHA, eq.Business, eq.ProcessStreamFluid, eq.OperatingPressure, eq.PHARating, eq.BusinessLossValue, eq.Group, eq.Type, eq.EquipmentDescription, eq.UnitCode);
        }
        public void edit(Equipment eq, String olderItemNo)
        {
            eqUtils.edit(eq.ItemNo, eq.Name, eq.Qty, eq.Semi_Quanty, eq.Quanlitative, eq.ProcessStream, eq.Pressure, eq.PHA, eq.Business, eq.ProcessStreamFluid, eq.OperatingPressure, eq.PHARating, eq.BusinessLossValue, eq.Group, eq.Type, eq.EquipmentDescription, eq.UnitCode, olderItemNo);
        }
